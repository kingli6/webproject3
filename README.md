...
A school website that allows users to create accounts, register to courses, an admin section that can administer(CRUD) users and courses registered in the database.
...
### Create an Admin and User account to log into the application.
    ...
    Either use Swagger or the "Create Account" button in the front page to create users.

#### http://localhost:5223/swagger

    Create a user at: /api/v3/auth/createUser
    {
    ...
    Create a new course at: /api/v3/courses/AddCourse
    {"courseId": 1,
    "courseNumber": "0001",
    "name": "Programming",
    "duration": "Three weeks",
    "description": "The program will teach you simple and useful logic manupilation with programming languages. ",
    "details": "string",
    "category": "Logic"
    }
